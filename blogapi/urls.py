...
from rest_framework.schemas import get_schema_view  # old
...
API_TITLE = 'Blog API'
API_DESCRIPTION = 'An API for a blog post to implement all the CRUD functionalities'
...
urlpatterns = [
    ...
    path('docs/', include_docs_urls(title=API_TITLE, description=API_DESCRIPTION)), # Human readable form
    path('swagger-docs/', schema_view),                                             # new
    # path('schema', schema_view), # Machine readable
