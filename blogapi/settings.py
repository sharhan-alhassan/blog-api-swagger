...
SECRET_KEY = 'django-insecure-l3=v^q*%7mn3cci81hb(@g#d&@(&2ys^*vqp170_2g6n-2fot%'
...
INSTALLED_APPS = [
    ...
    'rest_framework_swagger',   # OpenAPI for API documentation
]
...
# Explicitly allowing permissions for only authenticated users: Project-level permission
REST_FRAMEWORK = {
    ...
    'DEFAULT_SCHEMA_CLASS': 'rest_framework.schemas.coreapi.AutoSchema' # solves 'autoschema object has no attribute get_link'
}
